...
var GithubService = (function () {
    ...
    GithubService.prototype.getUserInfo = function (username) {
        ...
        return this.http.get("https://api.github.com/users/" + username + "?client_id=" + this.client_id + "&client_secret=" + this.client_secret).map(function (res) { return res.json(); });
    };
    GithubService.prototype.getUserRepo = function (username) {
        ...
        return this.http.get("https://api.github.com/users/" + username + "/repos?client_id=" + this.client_id + "&client_secret=" + this.client_secret).map(function (res) { return res.json(); });
    };
